...
public class RemoveCommand extends AbstractAsyncCommand {
    ...
    public RemoveCommand(@Nonnull String name, @Nonnull String description) {
        ...
        this.playerName = (RequiredArg)this.withRequiredArg("player", "The player to remove money to", ArgTypes.PLAYER_REF).suggest((sender, text, paramCount, result) -> {
        ...
        this.amount = this.withRequiredArg("amount", "The amount of money to remove", ArgTypes.FLOAT);
    }
    ...
    protected CompletableFuture<Void> executeAsync(@Nonnull CommandContext commandContext) {
        try {
            ...
            float amountToRemove = (Float)this.amount.get(commandContext);
